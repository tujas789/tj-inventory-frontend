...
const APP_TEXT = {
  ...
  common: {
    ...
    // [T-074] ข้อความตอน fetch หมดเวลา — แยก 2 แบบตามความปลอดภัยของการกดซ้ำ (ดู REPEAT_UNSAFE ใน api.js)
    timeoutTpl:       'หมดเวลารอ {sec} วินาที (เน็ตช้า/หลุด) — ลองใหม่อีกครั้งได้',
    timeoutUnsafeTpl: 'หมดเวลารอ {sec} วินาที — ⚠️ อย่าเพิ่งกดซ้ำ! ระบบอาจบันทึกไปแล้ว กรุณาเช็คหน้าสต๊อกก่อน',
  },
  tabs: {
    issue:   '🫗 เบิก',
    receive: '🧺 รับเข้า',
